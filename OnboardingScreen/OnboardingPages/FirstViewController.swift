...
//  OnboardingScreen
//
//  Created by Юлия Караневская on 29.09.21.
//
...
class FirstViewController: UIViewController {
    ...
    let orangeImageView: UIImageView = {
        ...
        imageV.image = UIImage(named: "orangeImage")
    ...
    let largeTextLabel: UILabel = {
        let label = UILabel()
        label.text = "Узнавай первым о всех акциях и мероприятих"
    ...
    let smallTextLabel: UILabel = {
        let label = UILabel()
        label.text = "Все мероприятия, шоу и встречи Острова Мечты"
        label.textAlignment = .center
